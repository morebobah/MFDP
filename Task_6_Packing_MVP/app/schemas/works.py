...
class SWorks(BaseModel):
    ...
    packet: int = Field(..., example=1, description="Номер пакета")
...
class SWorksPacket(BaseModel):
    packet: int = Field(..., description="Номер пакета")
